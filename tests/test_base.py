...
AUTH_MFA_MAIL_RESPONSE_PATH = os.path.join(ABS_PATH, "AUTH_MFA_MAIL_RESPONSE")
AUTH_MFA_MAIL_RESPONSE = open(AUTH_MFA_MAIL_RESPONSE_PATH, 'r').read()
AUTH_MFA_MAIL_ISSUE_CHALLENGE_RESPONSE_PATH = os.path.join(ABS_PATH, "AUTH_MFA_MAIL_ISSUE_CHALLENGE_RESPONSE")
AUTH_MFA_MAIL_ISSUE_CHALLENGE_RESPONSE = open(AUTH_MFA_MAIL_ISSUE_CHALLENGE_RESPONSE_PATH, 'r').read()
