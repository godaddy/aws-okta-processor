...
SIGN_IN_RESPONSE_V1_PATH = os.path.join(ABS_PATH, "SIGN_IN_RESPONSE_V1")
SIGN_IN_RESPONSE_V1 = open(SIGN_IN_RESPONSE_V1_PATH, 'r').read()
SIGN_IN_RESPONSE_V2_PATH = os.path.join(ABS_PATH, "SIGN_IN_RESPONSE_V2")
SIGN_IN_RESPONSE_V2 = open(SIGN_IN_RESPONSE_V2_PATH, 'r').read()
